...
export const saveLessonProgress = async (
  ...
  try {
    ...
    // Если отмечено как завершённое, увеличиваем lessons_completed в профиле
    if (isCompleted) {
      ...
      const currentCount = profileData?.lessons_completed || 0;
      ...
      if (updateError) {
        console.error('Ошибка при обновлении lessons_completed в профиле:', updateError);
      }
    }
